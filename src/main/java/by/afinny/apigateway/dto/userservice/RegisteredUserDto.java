...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "DTO for response registered user")
public class RegisteredUserDto {
    ...
    @Schema(description = "is sms notification enable")
    private boolean smsNotification;
    @Schema(description = "is push notification enable")
    private boolean pushNotification;
    @Schema(description = "application registration date")
